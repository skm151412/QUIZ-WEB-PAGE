...
// Backend port updated to 8081 (configurable). If you revert backend to 8080 update here too.
const API_BASE_URL = (window.QUIZ_BACKEND_BASE || 'http://localhost:8081') + '/api/quiz';
